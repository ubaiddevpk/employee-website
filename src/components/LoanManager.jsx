...
const LoanManager = ({ isDarkMode, loans, onAdd, onUpdate, onRemove }) => {
  ...
  const getTotalLoanAmount = () => {
    return loans.reduce((sum, loan) => sum + Number(loan.originalAmount || 0), 0);
  };
      ...
      <div className="flex justify-between items-center mb-4">
        <div>
          ...
          <div className={`text-sm mt-1 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
            Total: PKR {getTotalLoanAmount().toLocaleString()} | 
            Deducted: PKR {getTotalDeductions().toLocaleString()} | 
            Remaining: PKR {getRemainingAmount().toLocaleString()}
          </div>
        </div>
        <button
          type="button"
              ...
              <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => onUpdate(loan.id, "originalAmount", e.target.value)}
                ...
                <div>
                  ...
                  <input
                    ...
                    value={loan.reason || ''}
                    onChange={(e) => onUpdate(loan.id, "reason", e.target.value)}
                    className={inputStyle}
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => onUpdate(loan.id, "deduction", e.target.value)}
                    className={inputStyle}
                  />
                </div>
                ...
                <div>
                  ...
                  <div className={`w-full px-3 py-2 border rounded-lg ${
                    ...
                    {(Number(loan.originalAmount || 0) - Number(loan.deduction || 0)).toLocaleString()}
                  </div>
                </div>
              </div>
            </div>
