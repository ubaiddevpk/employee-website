          ...
          {history.map((h, idx) => (
            <tr key={idx}>
              ...
              <td className="px-3 py-2 border">
                AED {Number(h.gross || 0).toLocaleString()}
              </td>
              <td className="px-3 py-2 border">
                AED {Number(h.totalAdvance || 0).toLocaleString()}
              </td>
              <td className="px-3 py-2 border">
                AED {Number(h.totalLoanDeduction || 0).toLocaleString()}
              </td>
              <td className="px-3 py-2 border">
                AED {Number(h.net || 0).toLocaleString()}
              </td>
            </tr>
          ))}
        </tbody>
