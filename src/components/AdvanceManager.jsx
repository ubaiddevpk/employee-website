...
const AdvanceManager = ({ isDarkMode, advances, onAdd, onUpdate, onRemove }) => {
  ...
  const getTotalAdvanceAmount = () => {
    return advances.reduce((sum, adv) => sum + Number(adv.originalAmount || 0), 0);
  };
      ...
      <div className="flex justify-between items-center mb-4">
        <div>
          ...
          <div className={`text-sm mt-1 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
            Total: PKR {getTotalAdvanceAmount().toLocaleString()} | 
              ...
              <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
                <div>
                  ...
                  <input
                    ...
                    step="0.01"
                    value={adv.originalAmount || ''}
                    onChange={(e) => onUpdate(adv.id, "originalAmount", e.target.value)}
                ...
                <div>
                  ...
                  <input
                    ...
                    step="0.01"
                    value={adv.deduction || ''}
                    onChange={(e) => onUpdate(adv.id, "deduction", e.target.value)}
                    className={inputStyle}
                  />
                </div>
                ...
                <div>
                  ...
                  <div className={`w-full px-3 py-2 border rounded-lg ${
                    ...
                    {(Number(adv.originalAmount || 0) - Number(adv.deduction || 0)).toLocaleString()}
                  </div>
                </div>
              </div>
            </div>
